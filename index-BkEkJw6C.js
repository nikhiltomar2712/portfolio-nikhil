...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ka(){return new Ar({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ja(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qa(){return new Ar({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ja(),fragmentShader:`
...
void main() {
    ...
    <nav class="topbar" aria-label="Portfolio pages">
      ...
      <div class="nav-links">
        ${i.map(t=>`
              <a class="${t.id===e?`active`:``}" href="#/${t.id}">
  ...
  `}function Dc(e,t){return`
    ${Ec(e)}
    <main class="page-shell" data-page="${e}">
      ${t}
    </main>
  `}function Oc(){return Dc(`home`,`
      <section class="hero-grid">
        <div class="hero-copy">
          <p class="eyebrow">GitHub: @${r.handle} / ${r.location}</p>
          <h1 class="glow-title">${r.headline}</h1>
          <p class="hero-intro">${r.introduction}</p>
          <div class="hero-actions">
            <a data-magnetic class="action primary" href="#/projects">View Operations</a>
            <a data-magnetic class="action ghost" href="${r.github}" target="_blank" rel="noreferrer">Open GitHub</a>
          </div>
        </div>
        <aside class="hud-panel hero-hud" aria-label="Mission summary">
          ...
          <dl class="mission-list">
            <div><dt>Goal</dt><dd>${r.target}</dd></div>
            <div><dt>Role</dt><dd>Red Team Security</dd></div>
            <div><dt>Language</dt><dd>${r.japaneseLevel}</dd></div>
          </dl>
          <div id="console-slot"></div>
        </aside>
      </section>
      <section class="signal-strip">
        ${r.strengths.map(e=>`<span>${e}</span>`).join(``)}
      </section>
    `)}function kc(){return Dc(`about`,`
      <section class="two-column">
        <div>
          <p class="eyebrow">Profile Signal</p>
          <h1 class="glow-title compact">Builder, learner, operator.</h1>
          <p class="body-large">${r.mission}</p>
    ...
    `)}function Ac(){return Dc(`arsenal`,`
      ...
      <section class="arsenal-grid">
        ${[[`Recon`,`Map attack surfaces, enumerate assets, document signals, and convert noise into useful paths.`],[`Web Security`,`Practice injection, auth logic, access control, API behavior, and clean responsible reporting.`],[`Automation`,`Use Python and TypeScript to build repeatable security workflows and visual dashboards.`],[`Red Team Labs`,`Train on privilege escalation, lateral movement concepts, OPSEC, payload discipline, and reporting.`],[`Defensive Mindset`,`Understand detections, logs, threat hunting, and how defenders see attacker behavior.`],[`Japanese Work Readiness`,`Build vocabulary for technical communication, interviews, documentation, and workplace etiquette.`]].map(([e,t],n)=>`<article class="tool-card" style="--i:${n}"><h2>${e}</h2><p>${t}</p></article>`).join(``)}
      </section>
      <section class="code-wall" aria-label="Technology stack">
        ${r.stack.map(e=>`<code>${e}</code>`).join(``)}
      </section>
    `)}function jc(){return Dc(`projects`,`
      <section class="page-heading">
      ...
      <section class="project-grid">
        ${r.projects.map(e=>`
              <article class="project-card">
                ...
                <p>${e.signal}</p>
                <div class="tag-row">${e.stack.map(e=>`<span>${e}</span>`).join(``)}</div>
                <a href="${e.github}" target="_blank" rel="noreferrer">Open repository</a>
              </article>`).join(``)}
      </section>
    `)}function Mc(){return Dc(`japan`,`
    ...
    `)}var Nc={home:Oc,about:kc,arsenal:Ac,projects:jc,japan:Mc};function Pc(){Tc();let e=a(window.location.hash||`#/home`);document.title=o(e),Cc.innerHTML=Nc[e](),wc.setIntensity(e===`home`?1.15:.72);let r=Cc.querySelector(`#console-slot`),i=r?t(r):()=>{},s=n(Cc);Tc=()=>{i(),s()}}window.addEventListener(`hashchange`,Pc),Pc();